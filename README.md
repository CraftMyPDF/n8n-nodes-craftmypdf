...
| Create Image  | `create-image` | Creates an image file with JSON data and your template.                                                                      | Create an image             | [Link](https://craftmypdf.com/docs/index.html#tag/Image-Generation-API/operation/create-image)  |
